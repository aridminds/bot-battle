...
public class FireControlComputerTest
{
    ...
    public void CalculateShootingRange_Square_Map_FullPower_CenterTank_Middle_Test(Direction direction,
    ...
    public void CalculateShootingRange_Square_Map_FullPower_CenterTank_North_GroundZero_Test(Direction direction,
        int expectedShootingRange)
    {
        //Arrange
        const int width = 10;
    ...
    public void CalculateShootingRange_Rectangular_Map_FullPower_Middle_CenterTank_Test(Direction direction,
        int rawShootingRange,
        int expectedShootingRange)
    {
        //Arrange
        const int width = 20;
    ...
    public void CalculateShootingRange_Rectangular_Map_FullPower_Middle_EdgeTank_Test(Direction direction,
        int rawShootingRange,
        int expectedShootingRange)
    {
        //Arrange
    ...
    public void CalculateShootingRange_Rectangular_Map_FullPower_Middle_GroundZero_Test(Direction direction,
        int rawShootingRange,
        int expectedShootingRange)
    {
        //Arrange
    ...
    [InlineData(Direction.SouthWest, 255, 0)]
    public void CalculateShootingRange_Rectangular_Map_FullPower_North_GroundZero_Test(Direction direction,
        int rawShootingRange,
        int expectedShootingRange)
    {
        //Arrange
    ...
    [InlineData(Direction.SouthWest, 255, 0)]
    public void CalculateShootingRange_Rectangular_Map_FullPower_South_GroundZero_Test(Direction direction,
        int rawShootingRange,
        int expectedShootingRange)
    {
        //Arrange
    ...
    [InlineData(Direction.SouthEast, 255, 0)]
    [InlineData(Direction.SouthWest, 255, 0)]
    public void CalculateShootingRange_Rectangular_Map_FullPower_South_GroundZeroWest_Test(Direction direction,
        int rawShootingRange,
        int expectedShootingRange)
    {
        //Arrange
    ...
    public void CalculateShootingRange_Rectangular_Map_FullPower_North_GroundZeroWest_Test(Direction direction,
        int rawShootingRange,
        int expectedShootingRange)
    {
        //Arrange
