...
public class StreetConnectionService
{
    ...
    public StreetTypes GetRandomConnection(StreetTypes currentStreetType)
    {
        ...
        var index = _random.Next(possibleConnections.Count);
    ...
    public List<StreetTypes> GetPossibleConnections(StreetTypes currentStreetType)
    {
        switch (currentStreetType)
        {
            ...
            case StreetTypes.StraightVertical:
                return new List<StreetTypes>
                    { StreetTypes.StraightHorizontal, StreetTypes.StraightVertical, StreetTypes.Cross };
            ...
            case StreetTypes.CornerBottomRight:
                return new List<StreetTypes>
                {
                    StreetTypes.StraightHorizontal, StreetTypes.StraightVertical, StreetTypes.CornerTopLeft,
                    StreetTypes.CornerTopRight, StreetTypes.CornerBottomLeft, StreetTypes.CornerBottomRight
                };
